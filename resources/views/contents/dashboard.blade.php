<div class="p-4 sm:ml-64">
    <div class="p-4  mt-14">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div class="flex text-right items-center justify-end rounded h-50 dark:bg-gray-800"></div>
            <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                <div class="flex justify-between items-start w-full">
                    <div class="flex-col items-center">
                        <div class="flex items-center mb-1">
                            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Works chart</h5>
                            ...
                            <div data-popover id="chart-info" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                <div class="p-3 space-y-2">
                                    <h3 class="font-semibold text-gray-900 dark:text-white">Activity works - Incremental</h3>
                                    <p>Report helps navigate work activities. Ideally, the chart should have a growing trend, as stagnating chart signifies a significant decrease of work activity.</p>
                                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="grid grid-cols-3 gap-3 mb-2">
                        <dl class="bg-orange-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                            <dt class="w-8 h-8 rounded-full bg-orange-100 dark:bg-gray-500 text-orange-600 dark:text-orange-300 text-sm font-medium flex items-center justify-center mb-1">{{count($workorders->whereIn('status',['Starting']))}}</dt>
                            <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">To do</dd>
                        </dl>
                        <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                            <dt class="w-8 h-8 rounded-full bg-teal-100 dark:bg-gray-500 text-teal-600 dark:text-teal-300 text-sm font-medium flex items-center justify-center mb-1">{{count($workorders->whereIn('status',['Working']))}}</dt>
                            <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">In progress</dd>
                        </dl>
                        <dl class="bg-blue-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                            <dt class="w-8 h-8 rounded-full bg-blue-100 dark:bg-gray-500 text-blue-600 dark:text-blue-300 text-sm font-medium flex items-center justify-center mb-1">{{count($workorders->whereIn('status',['Finished','Closed']))}}</dt>
...
<script>
    ...
    const getChartOptions = () => {
        return {
            series: [{{count($workorders->whereIn('status',['Starting']))}}, {{count($workorders->whereIn('status',['Woriking']))}}, {{count($workorders->whereIn('status',['Finished','Closed']))}}],
            ...
            labels: ["Starting", "Working", "Finished/Closed"],
            dataLabels: {
                enabled: true,
                style: {
